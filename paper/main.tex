...
$\times$ two noise models). Accumulated channel damage fixes end-state
...
first three sizes agree within $0.004$ ($0.738$--$0.742$
...
calibrated, not conservative. A constant fit to the plateau then gives
$\chi^2/\mathrm{dof}=0.015$, a low $1.5\%$ fluctuation on
correctly-sized bars rather than evidence for flatness; we therefore
quote the raw spread there and reserve significance for the fall,
which the same calibration leaves at $4.15\sigma$.
...
them. Fractional gate costs are exact: both channel families form
